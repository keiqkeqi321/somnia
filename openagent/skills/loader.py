...
class SkillLoader:
    ...
    def for_workspace(cls, workspace_root: Path) -> "SkillLoader":
        return cls(
            [
                Path.home() / ".openagent" / "skills",
                workspace_root / "skills",
                workspace_root / ".openagent" / "skills",
            ]
        )
    ...
    def _scope_name(self, source_dir: Path) -> str:
        home_skills_dir = Path.home() / ".openagent" / "skills"
        if source_dir == home_skills_dir:
            return "global"
        if source_dir.name == "skills" and source_dir.parent.name == ".openagent":
            return "workspace"
