...
const translations = {
  "en-US": {
    ...
    "settings.remote.reapplyHint": "The project list changed — disable and re-enable remote control to apply the change.",
  ...
  "zh-CN": {
    ...
    "settings.remote.reapplyHint": "项目列表已变化——请停用并重新启用远程控制以应用变更。",
