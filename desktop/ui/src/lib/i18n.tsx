...
const translations = {
  "en-US": {
    ...
    "settings.remote.relayUrl": "Relay URL",
    "settings.remote.pairAndEnable": "Pair and enable",
    "settings.remote.pairPending": "Pairing request sent — confirm it in the browser tab that just opened.",
    "settings.remote.cancelPair": "Cancel pairing",
    "settings.remote.working": "Working…",
    "settings.remote.device": "Device",
    "settings.remote.relay": "Relay",
    "settings.remote.state": "Status",
    "settings.remote.online": "Online",
    "settings.remote.offline": "Offline",
    "settings.remote.enable": "Enable remote control",
    "settings.remote.disable": "Disable remote control",
    "settings.remote.unpair": "Remove pairing",
    "settings.remote.unpairConfirm": "Remove the pairing, delete this device's identity, and stop remote control?",
    "settings.remote.lastError": "Last error: {error}",
    "settings.remote.projects": "Exposed projects",
    ...
    "settings.config.disableMcpTool": "Disable this tool for chat",
    "settings.config.enableMcpTool": "Enable this tool for chat",
    "settings.config.mcpToolEnabled": "Enabled tool {tool} on {name}.",
    "settings.config.mcpToolDisabled": "Disabled tool {tool} on {name}.",
    ...
    "remote.selectProject": "Select Project",
    "remote.connect": "Connect",
    "remote.pairingName": "New Device name",
    "remote.createPairing": "Create pairing code",
    "remote.addDevice": "Add Device",
    "remote.close": "Close",
    "remote.revokeDevice": "Revoke selected Device",
    "remote.switchTarget": "Switch device / project",
    "remote.noProjects": "This Device has no registered projects.",
    "remote.state.connected": "Connected",
    "remote.state.connecting": "Connecting to remote device…",
    "remote.state.disconnected": "Remote connection lost; reconnecting…",
    "remote.state.error": "Remote connection error",
    "remote.reconnecting": "Remote connection lost. Reconnecting automatically…",
    ...
    "remote.continueWithGitHub": "Continue with GitHub",
    "remote.continueWithGitee": "Continue with Gitee",
    "remote.continueWithProvider": "Continue with {provider}",
    "remote.noOAuthProviders": "No sign-in channel is configured.",
    "remote.bindGitHub": "Bind GitHub account",
    "remote.bindProvider": "Bind {provider} account",
    "remote.unbindGitHub": "Unbind",
    "remote.newPassword": "New password",
    "remote.setPassword": "Set password",
    "remote.passwordTooShort": "Password must be at least 8 characters.",
    "remote.passwordMismatch": "Passwords do not match.",
    "remote.pair.title": "Pair a device",
    "remote.pair.description": "A Somnia Desktop is asking to pair a device with your account. Confirm the device name and approve.",
    "remote.pair.deviceName": "Device name",
    "remote.pair.approve": "Approve pairing",
    "remote.pair.approving": "Approving…",
  ...
  "zh-CN": {
    ...
    "settings.remote.description": "将本机与 Somnia Relay 配对后，即可通过浏览器远程控制本机。配对会在浏览器中打开确认页面，无需在此输入凭据。",
    "settings.remote.relayUrl": "Relay 地址",
    "settings.remote.pairAndEnable": "配对并启用",
    "settings.remote.pairPending": "配对请求已发送，请在刚打开的浏览器标签页中确认。",
    "settings.remote.cancelPair": "取消配对",
    "settings.remote.working": "处理中…",
    "settings.remote.device": "设备",
    "settings.remote.relay": "Relay",
    "settings.remote.state": "状态",
    "settings.remote.online": "在线",
    "settings.remote.offline": "离线",
    "settings.remote.enable": "启用远程控制",
    "settings.remote.disable": "停用远程控制",
    "settings.remote.unpair": "取消配对",
    "settings.remote.unpairConfirm": "确定取消配对并删除本机设备身份、停止远程控制吗？",
    "settings.remote.lastError": "最近错误：{error}",
    "settings.remote.projects": "已暴露项目",
    ...
    "settings.config.disableMcpTool": "在聊天中禁用此工具",
    "settings.config.enableMcpTool": "在聊天中启用此工具",
    "settings.config.mcpToolEnabled": "已启用 {name} 的工具 {tool}。",
    "settings.config.mcpToolDisabled": "已禁用 {name} 的工具 {tool}。",
    ...
    "remote.project": "项目",
    "remote.selectProject": "选择项目",
    "remote.connect": "连接",
    "remote.pairingName": "新设备名称",
    "remote.createPairing": "生成配对码",
    "remote.addDevice": "添加设备",
    "remote.close": "关闭",
    "remote.revokeDevice": "吊销所选设备",
    "remote.switchTarget": "切换设备/项目",
    "remote.noProjects": "该设备没有已注册的项目。",
    "remote.state.connected": "已连接",
    "remote.state.connecting": "正在连接远程设备…",
    "remote.state.disconnected": "远程连接已断开，正在重连…",
    "remote.state.error": "远程连接错误",
    "remote.reconnecting": "远程连接已断开，正在自动重连…",
    ...
    "remote.continueWithGitHub": "使用 GitHub 继续",
    "remote.continueWithGitee": "使用 Gitee 继续",
    "remote.continueWithProvider": "使用 {provider} 继续",
    "remote.noOAuthProviders": "未配置可用的登录渠道。",
    "remote.bindGitHub": "绑定 GitHub 账号",
    "remote.bindProvider": "绑定 {provider} 账号",
    "remote.unbindGitHub": "解绑",
    "remote.newPassword": "新密码",
    "remote.setPassword": "设置密码",
    "remote.passwordTooShort": "密码长度至少为 8 个字符。",
    "remote.passwordMismatch": "两次输入的密码不一致。",
    "remote.pair.title": "配对设备",
    "remote.pair.description": "一台 Somnia Desktop 请求将设备配对到你的账号。确认设备名称后点击批准。",
    "remote.pair.deviceName": "设备名称",
    "remote.pair.approve": "批准配对",
    "remote.pair.approving": "正在批准…",
