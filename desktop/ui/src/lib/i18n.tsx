...
const translations = {
  "en-US": {
    ...
    "settings.config.visionModelHint": "Choose the shared provider and model used when image understanding needs a fallback.",
  ...
  "zh-CN": {
    ...
    "settings.config.visionModelHint": "选择图片理解需要 fallback 时使用的公共 provider 和模型。",
