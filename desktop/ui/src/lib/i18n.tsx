...
const translations = {
  "en-US": {
    ...
    "settings.config.visionModel": "Vision model",
    "settings.config.visionProvider": "Vision provider",
    "settings.config.visionModelHint": "Choose the provider and model used only for image understanding.",
    "settings.config.activeProvider": "Active provider",
    "settings.config.noVisionModel": "No dedicated vision model",
    ...
    "composer.visionModel": "Vision model",
  ...
  "zh-CN": {
    ...
    "settings.config.visionModel": "视觉模型",
    "settings.config.visionProvider": "视觉 provider",
    "settings.config.visionModelHint": "选择仅用于图片理解的 provider 和模型。",
    "settings.config.activeProvider": "当前 provider",
    "settings.config.noVisionModel": "不使用专用视觉模型",
