...
const translations = {
  "en-US": {
    ...
    "settings.config.runtimeTitle": "Runtime Limits",
    "settings.config.mcpTitle": "MCP Servers",
    "settings.config.hooksTitle": "Hooks",
    "settings.config.systemPromptTitle": "System Prompt",
    "settings.runtimeLimits.soft": "Soft reminder",
    "settings.runtimeLimits.hardStreak": "Hard streak limit",
    "settings.runtimeLimits.hardTotal": "Hard total limit (0 disables)",
    ...
    "settings.config.runtimeMcpHint": "Click the refresh button to inspect registered tools from the running sidecar.",
    ...
    "settings.config.debug": "Refresh tools",
    ...
    "settings.providerProfiles.projectTomlPreview": "Project overrides TOML",
    ...
    "settings.providerProfiles.addModel": "Add model",
    "settings.providerProfiles.addModelConfirm": "Add",
    "settings.providerProfiles.modelName": "Model ID",
    "settings.providerProfiles.removeModel": "Remove model",
    "settings.providerProfiles.cancel": "Cancel",
    "settings.providerProfiles.inherited": "Inherited",
    "settings.providerProfiles.projectOverride": "Project override",
    "settings.providerProfiles.revert": "Revert",
    "settings.providerProfiles.revertProvider": "Revert provider",
    ...
    "settings.providerProfiles.defaultBadge": "Default",
    ...
    "taskGraph.hint": "Use task_create_batch to build a task graph for longer work.",
  ...
  "zh-CN": {
    ...
    "settings.config.runtimeTitle": "运行时限制",
    "settings.config.mcpTitle": "MCP 服务器",
    "settings.config.hooksTitle": "Hooks",
    "settings.config.systemPromptTitle": "系统提示词",
    "settings.runtimeLimits.soft": "软提醒阈值",
    "settings.runtimeLimits.hardStreak": "连续硬停阈值",
    "settings.runtimeLimits.hardTotal": "总量硬停阈值（0 关闭）",
    ...
    "settings.providerProfiles.projectTomlPreview": "项目覆盖 TOML",
    ...
    "settings.providerProfiles.addModel": "添加模型",
    "settings.providerProfiles.addModelConfirm": "添加",
    "settings.providerProfiles.modelName": "模型 ID",
    "settings.providerProfiles.removeModel": "删除模型",
    "settings.providerProfiles.cancel": "取消",
    "settings.providerProfiles.inherited": "继承",
    "settings.providerProfiles.projectOverride": "项目覆盖",
    "settings.providerProfiles.revert": "还原",
    "settings.providerProfiles.revertProvider": "还原 provider",
    ...
    "settings.providerProfiles.defaultBadge": "默认",
    ...
    "taskGraph.expand": "展开",
    "taskGraph.hint": "使用 task_create_batch 构建任务图来管理较长的工作。",
    "taskGraph.close": "关闭",
