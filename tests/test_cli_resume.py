...
class CliResumeTests(unittest.TestCase):
    ...
    def test_resumed_history_uses_chat_output_styles(self) -> None:
        ...
        self.assertNotIn("think 99 chars", rendered)
        self.assertNotIn("think 7 chars", rendered)
        self.assertNotIn("thinking/session.turn.jsonl", rendered)
        self.assertNotIn("thinking/session.final.jsonl", rendered)
        ...
        self.assertLess(rendered.index("● Title"), rendered.index("Final answer."))
